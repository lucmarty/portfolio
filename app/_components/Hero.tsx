    ...
    <Section className="flex max-md:flex-col items-start">
      <div className="flex-[2] w-full flex flex-col gap-2">
        ...
        <BlurFade delay={0.1*3} inView>
          <p className="font-satoshi ml-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo mollitia totam esse perferendis iste iure voluptas expedita 
